...
#
# $Id: Rear3.py 27914 2006-02-13 14:32:08Z locilka $
#
# Representation of the configuration of rear.
...
# Settings: Define all variables needed for configuration of rear
...
def Read():
    ...
    caption = _("Initializing rear Configuration")
...
def Write():
    # Rear read dialog caption
    caption = _("Saving rear Configuration")
...
##
 # Get all rear settings from the first parameter
...
##
 # Dump the rear settings to a single map
 # (For use by autoinstallation.)
